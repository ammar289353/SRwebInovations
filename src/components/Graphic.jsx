      ...
      <section>
            ...
            <section className='w-[94vw] m-auto mb-10 mt-10'>
               <div className='block sm:block md:flex lg:flex'>
                ...
                <div className='w-[90vw] sm:w-[90vw] md:w-[50vw] lg:w-[50vw] ml-0 sm:ml-0 md:ml-10 lg:ml-10 mt-10 sm:mt-10 md:mt-28 lg:mt-28 text-center sm:text-center md:text-start lg:text-start'>
