    ...
    <>
     ...
     {/* Our value */}
      <section className='bg-[#F0F6FB] pb-12 sm:pb-12 md:pb-0 lg:pb-0 '>
       <div className='w-[94vw] h-auto sm:h-auto md:h-auto lg:h-[46vw] m-auto'>
        <div className='block sm:block md:flex lg:flex'>
            ...
            <div className='w-[80vw] sm:w-[85vw] md:w-[30vw] lg:w-[30vw] pt-10'>
              <div className='w-[93vw] h-auto sm:w-[40vw] sm:h-auto md:w-[26vw] md:h-auto lg:w-[26vw] lg:h-[16vw] bg-white rounded-lg p-5 sm:p-5 md:p-8 lg:p-8 hover:bg-[#093E86] text-black hover:text-white'>
              ...
              <div className='w-[93vw] mt-3 sm:mt-4 md:mt-4 lg:mt-4 h-auto sm:w-[40vw] sm:h-auto md:w-[26vw] md:h-auto lg:w-[26vw] lg:h-[16vw] bg-white rounded-lg p-5 sm:p-5 md:p-8 lg:p-8 hover:bg-[#093E86] text-black hover:text-white'>
            ...
            <div className='w-[93vw] h-auto sm:w-[40vw] sm:h-auto md:w-[26vw] md:h-auto lg:w-[26vw] lg:h-[16vw] bg-white rounded-lg p-5 sm:p-5 md:p-8 lg:p-8 hover:bg-[#093E86] text-black hover:text-white'>
              ...
              <div className='w-[93vw] h-auto sm:w-[40vw] sm:h-auto md:w-[26vw] md:h-auto lg:w-[26vw] lg:h-[16vw] bg-white rounded-lg p-5 sm:p-5 md:p-8 lg:p-8 hover:bg-[#093E86] text-black hover:text-white mt-3 sm:mt-4 md:mt-4 lg:mt-4'>
      ...
      <section className='bg-[#093E86]'>
        <div className='w-[95vw] h-auto sm:w-[95vw] sm:h-auto md:w-[95vw] md:h-[56vw] lg:w-[95vw] lg:h-[55vw] m-auto'>
          <div className='block sm:block md:flex lg:flex'>
            ...
            <div className='w-[90vw] sm:w-[90vw] md:w-[50vw] lg:w-[50vw] p-8 pt-5 sm:pt-5 md:pt-24 lg:pt-24 text-gray-300 text-[2.5vw] sm:text-[2.5vw] md:text-[1.2vw] lg:text-[1.2vw]'>
...
We are passionate about assisting our clients in leveraging technology to transform their businesses. Our team of experts works closely with each client to understand their unique needs and create customized solutions that meet their specific goals. With our state-of-the-art solutions, our clients can streamline their operations, improve efficiency, and unlock new revenue streams, all while staying ahead of the competition. If you’re ready to take your business to the new level of success, we’re here to help you every step of the way.</p>
          ...
          <div className='border-t-[0.1vw] border-gray-300 mt-5 sm:mt-5 md:mt-9 lg:mt-10'>
            ...
            <div className='text-white'>
                <h1 className='text-[3vw] sm:text-[3vw] md:text-[2.4vw] lg:text-[2.4vw] font-bold'>14K+</h1>
                <p className='text-[1.5vw] sm:text-[1.3vw] md:text-[1vw] lg:text-[1vw]'>Project Done</p>
            </div>
            <div className='text-white'>
                <h1 className='text-[3vw] sm:text-[3vw] md:text-[2.4vw] lg:text-[2.4vw] font-bold'>12K+</h1>
                <p className='text-[1.5vw] sm:text-[1.3vw] md:text-[1vw] lg:text-[1vw]'>Happy customer</p>
            </div>
            <div className='text-white'>
                <h1 className='text-[3vw] sm:text-[3vw] md:text-[2.4vw] lg:text-[2.4vw] font-bold'>4.7</h1>
                <p className='text-[1.5vw] sm:text-[1.3vw] md:text-[1vw] lg:text-[1vw]'>Review customer</p>
            </div>
            <div className='text-white'>
                <h1 className='text-[3vw] sm:text-[3vw] md:text-[2.4vw] lg:text-[2.4vw] font-bold'>15+</h1>
                <p className='text-[1.5vw] sm:text-[1.3vw] md:text-[1vw] lg:text-[1vw]'>Years Experience</p>
            </div>
            </div>
          </div>
        </div>
        ...
        <div className='h-auto sm:h-auto md:h-[19vw] lg:h-[19vw] pb-5 sm:pb-5 w-[90vw] bg-white m-auto'>
          <div className='bg-[#093E86] block sm:block md:flex lg:flex sm:w-[50vw] sm:h-auto md:w-[90vw] md:h-[13vw] lg:w-[90vw] lg:h-[13vw] rounded-lg mt-5 sm:mt-4 md:mt-28 lg:mt-28 text-center sm:text-center justify-between'>
            <div className='text-white p-2 sm:p-2 md:p-10 lg:p-10'>
                <h1 className='font-bold text-[2.5vw] sm:text-[2.5vw] md:text-[1.4vw] lg:text-[1.4vw]'>3345+ Projects Delivered</h1>
                <p className='text-[1.5vw] sm:text-[1.5vw] md:text-[0.8vw] lg:text-[0.8vw] pt-1 sm:pt-1 md:pt-3 lg:pt-3'>From marketing to development, and IT services, we empowered our diverse clientele with the best solutions.</p>
            </div>
            <div className='text-white p-2 sm:p-2 md:p-10 lg:p-10'>
                <h1 className='font-bold text-[2.5vw] sm:text-[2.5vw] md:text-[1.4vw] lg:text-[1.4vw]'>Years of Experience</h1>
                <p className='text-[1.5vw] sm:text-[1.5vw] md:text-[0.8vw] lg:text-[0.8vw] pt-1 sm:pt-1 md:pt-3 lg:pt-3'>We have been working in the industry for years and delivering custom solutions to businesses of all sizes. </p>
            </div>
            <div className='text-white p-2 sm:p-2 md:p-10 lg:p-10'>
                <h1 className='font-bold text-[2.5vw] sm:text-[2.5vw] md:text-[1.4vw] lg:text-[1.4vw]'>Creative Experts</h1>
                <p className='text-[1.5vw] sm:text-[1.5vw] md:text-[0.8vw] lg:text-[0.8vw] pt-1 sm:pt-1 md:pt-3 lg:pt-3'>Our team consists of experienced professionals who are dedicated to achieving success for our clients.</p>
            </div>
          </div>
        </div>
      </section>
